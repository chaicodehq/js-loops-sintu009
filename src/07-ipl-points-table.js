...
export function iplPointsTable(matches) {
  ...
  for (let i = 0; i < matches.length; i++) {
    ...
    if (!table[team1]) table[team1] = { team: team1, played: 0, won: 0, lost: 0, tied: 0, noResult: 0, points: 0 };
    if (!table[team2]) table[team2] = { team: team2, played: 0, won: 0, lost: 0, tied: 0, noResult: 0, points: 0 };
    table[team1].played++;
    table[team2].played++;
    if (result === "win") {
      table[winner].won++;
